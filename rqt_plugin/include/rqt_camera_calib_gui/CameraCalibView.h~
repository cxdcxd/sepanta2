...
private:
  ...
  virtual void chatterCallback_lasersensor(const athomerobot_msgs::irsensor::ConstPtr &msg);
  virtual void chatterCallback_omnispeed(const athomerobot_msgs::omnidata::ConstPtr &msg);
