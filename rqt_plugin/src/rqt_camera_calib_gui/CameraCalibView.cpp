...
{
   athomerobot_msgs::maptools srv_map;
...
{
    athomerobot_msgs::command srv_command;
...
void CameraCalibView::chatterCallback_omnispeed(const athomerobot_msgs::omnidata::ConstPtr &msg)
{
    s_Motor[0] = msg->d0;
    s_Motor[1] = msg->d1;
    s_Motor[2] = msg->d2;
...
void CameraCalibView::chatterCallback_lasersensor(const athomerobot_msgs::irsensor::ConstPtr &msg)
{
...
void CameraCalibView::initPlugin(qt_gui_cpp::PluginContext& context)
{
    ...
    chatter_pub1 = n1.advertise<athomerobot_msgs::omnidata>("/AUTROBOTIN_omnidrive", 1);
    ...
    chatter_pub4 = n4.advertise<athomerobot_msgs::arm>("/AUTROBOTIN_arm_right", 1);
    chatter_pub5 = n5.advertise<std_msgs::Int32>("AUTROBOTIN_gripper_right", 1); //grip right
    chatter_pub6 = n6.advertise<athomerobot_msgs::arm>("/AUTROBOTIN_arm_left", 1);
    chatter_pub7 = n7.advertise<std_msgs::Int32>("AUTROBOTIN_gripper_left", 1); //grip left
    chatter_pub8 = n8.advertise<athomerobot_msgs::head>("/AUTROBOTIN_head", 1); //head
    ...
    serviceclient_odometryslam = n_client3.serviceClient<athomerobot_msgs::command>("AUTROBOTINSRV_command");

    ros::NodeHandle n_client4;
    serviceclient_map = n_client4.serviceClient<athomerobot_msgs::maptools>("AUTROBOTINSRV_maptools");
